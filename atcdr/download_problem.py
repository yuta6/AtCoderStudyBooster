...
def generate_problem_directory(base_path: str, problems: List[Problem], gene_path:GenerateMode) -> None:
    for problem in problems:
        ...
        if title is None :
            ...
            title = f"problem{problem.number}{problem.difficulty}"
...
def convert_arg(arg: str) -> Union[int, Diff, range, List[Diff]]:
    if arg.isdigit():
        return [int(arg)]
